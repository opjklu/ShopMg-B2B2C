 ...
 *
 * @Entity()
 * @Table(name="mg_order_package_exchange_goods")
 * 
 * @uses DbOrderPackageExchangeGoods
 */
class DbOrderPackageExchangeGoods extends Model
{
    ...
    /**
     *
     * @var int $status 审核状态【0审核中1审核失败2审核通过3换货中4换货完成 5已撤销 】
    ...
    /**
     * 审核状态【0审核中1审核失败2审核通过3换货中4换货完成 5已撤销 】
     * 
     * @param int $value            
     * @return $this
     */
