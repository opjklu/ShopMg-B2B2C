 ...
 *
 * @Entity()
 * @Table(name="mg_order_package_exchange_progress")
 * 
 * @uses DbOrderPackageExchangeProgress
 */
class DbOrderPackageExchangeProgress extends Model
{
    ...
    /**
     *
     * @var int $exchangeId 商品换货【编号】
     *      @Column(name="exchange_id", type="integer", default=0)
     */
    private $exchangeId;
     ...
     * @return $this
     */
    public function setExchangeId(int $value): self
    {
