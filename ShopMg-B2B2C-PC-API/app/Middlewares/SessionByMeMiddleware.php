 ...
 */
class SessionByMeMiddleware implements MiddlewareInterface
{
     ...
     * @var string
     */
    const DEFAULT_SESSION_NAME = 'ME_SESSION_ID';
    ...
    {
        $domain = \Swoft\App::getBean('config')->get('cookie_domain');

        $path = '/';
        $secure = false; // strtolower($uri->getScheme()) === 'https';
        $httpOnly = true;
