...
class DbOrder extends Model
{
     ...
     *      @Column(name="coupon_deductible", type="float", default=0)
     */
     ...
     *
     * @var int $expId 快递表编号
     *      @Column(name="exp_id", type="integer")
     */
    private $expId;
     ...
     *      @Column(name="order_sn_id", type="string", length=50, default="000000")
     */
    private $orderSnId;
    ...
    /**
     *
     * @var int $orderType 订单类型0普通订单1货到付款
    ...
    /**
     *
     * @var float $priceSum 总价
     *      @Column(name="price_sum", type="float", default=0)
     */
    private $priceSum;
