  ...
  methods: {
      ...
      this.HTTP(
        ...
        .then(res => {
          if (res.message == "成功") {
            ...
            this.store_address = res.data.address; //详细
    ...
    changeWarning(sign) {
      switch (sign) {
        ...
        case 10:
          if (
            this.bank_account.length > 12 &&
            /^[1-9]\d*$/.test(this.bank_account)
          ) {
    ...
    next() {
      ...
      console.log(params);
      this.HTTP(this.$httpConfig.editPersonEnter, params, "post")
        .then(res => {
    ...
    .show {
      ...
      .bottom {
        ...
        .both {
          ...
          .photo {
            background: url(../../../assets/img/shangchuan.png) no-repeat 50%
              50%;
