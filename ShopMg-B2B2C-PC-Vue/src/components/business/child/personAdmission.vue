    ...
    <div class="middle">
      <div class="center">
        <div class="Box">
          ...
          <span>
            2:如您已经提交开店个人信息，请至--服务中心--
            <router-link to="/progressLook">查看进度</router-link>--选择--编辑信息--修改内容
          </span>
        </div>
        <div class="show">
          <div class="top">
...
export default {
  ...
  methods: {
    ...
    //获取省
    getProvince() {
      this.HTTP(this.$httpConfig.regionLists, { parent_id: 0 }, "post").then(
        res => {
    ...
    next() {
      ...
      console.log(params);
      this.HTTP(this.$httpConfig.setPersonEnter, params, "post")
        .then(res => {
