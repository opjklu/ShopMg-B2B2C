<template>
    <div class="r right">
        ...
        <div class="l zonghe">
            ...
            <p class="first">
                描述相符
                <span>{{Number(shop_data.desccredit)}}</span>
            </p>
            <p>
                服务态度
                <span>{{Number(shop_data.servicecredit)}}</span>
            </p>
            <p>
                发货速度
                <span>{{Number(shop_data.deliverycredit)}}</span>
            </p>
        </div>
        <div class="kefu l">
            <p>
    ...
    methods: {
        ...
        async getShopData() {
            this.HTTP(
                ...
                .then(res => {
                    this.shop_data = res.data.store;

                    if (
                        typeof res.data.address == "object" &&
                        Object.prototype.toString
                            .call(res.data.address)
