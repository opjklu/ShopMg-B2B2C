        ...
        <div class="g-main-n l">
          ...
          <div class="q_class_list l" :class="{active:onoff1}">
            <ul class="l" ref="priceHeight">
              <li
                class="l"
                v-for="(item, index) in selectGoods.price_member"
                :key="index"
...
export default {
  ...
  data() {
    return {
      ...
      selectGoods: {
        brand: [],
        price_member: ["0-500", "500-1000", "1000-2500"],
        color: ["黑色", "蓝色"],
        theard: [
  ...
  methods: {
    ...
    // 加入购物车
    addCar(id, price_member, storeId) {
      var params = {
        goods_id: id,
        goods_num: 1,
        price_new: price_member,
        store_id: storeId
      };
