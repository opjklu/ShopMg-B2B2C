		...
		<div class="center">
			...
			<div class="middle">
				<div class="left l">
					...
					<div class="down">
						<router-link  :to="{path:'/returnGoods',query:{id:$route.query.id,goods_id:$route.query.goods_id,order_sn_id:$route.query.order_sn_id}}">退款退货</router-link>
				...
				<div class="right r">
					...
					<ul class="ul">
						...
						<li>订单编号：<span class="lanse">{{$route.query.order_sn_id}}</span></li>
