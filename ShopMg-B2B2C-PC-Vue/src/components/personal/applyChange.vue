<template>
  <div class="exchange">
    ...
    <div class="center">
      ...
      <img class="logo" src="../../assets/img/huanhuo.png" />
      <div class="middle">
        <div class="left l">
  ...
  export default {
    ...
    methods: {
      submit() {
        ...
        this.HTTP(this.$httpConfig.customerService, {
        ...
        this.$ajax.post(this.$httpConfig.uploadImageByImageComment, form, config)
          .then(res => {
            if (res.status == 10001) {
              ...
              if (res.status === 1) {
                this.upload_list.push(res.data);
              } else {
                alert(res.message);
              }
            }
      ...
      orderInfo() {
        this.HTTP(this.$httpConfig.orderDetails, {
          ...
          for (let index = 0; index < res.data.goods.length; index++) {
            if (res.data.goods[index].goods_id === this.$route.query.goods_id) {
              this.goods = res.data.goods[index];
            }
          }
