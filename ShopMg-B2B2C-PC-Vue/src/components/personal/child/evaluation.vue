    ...
    methods: {
        ...
        toBeEvaluated() {
            this.HTTP(
                ...
                .then(res => {
                    this.toBeEvaluate = res.data.order;
        ...
        haveBeenEvaluated() {
            this.HTTP(
                ...
                .then(res => {
                    if (res.status) {
                        this.haveComment = res.data.order;
                        this.alreadyOrderGoodsData = res.data.order_goods;
        ...
        packageEvaluation() {
            this.HTTP(
                ...
                .then(res => {
                    this.type = 1;
                    this.setForEvaluation = res.data.order;
                    this.orderPackageGoodsData = res.data.order_goods;
        ...
        haveEvaluation() {
            this.HTTP(
                ...
                .then(res => {
                    console.log(res);
                    if (res.status) {
                        this.setEvaluated = res.data.order;
